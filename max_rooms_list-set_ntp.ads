...
package MAX_Rooms_List.Set_NTP is

   procedure Set_Selected_NTP (Rooms : Rooms_List);

private
   type NTP_Dialog_Record is new Gtk_Dialog_Record with record
      List    : Rooms_List;
      Cube    : RF_Address;
      Servers : Gtk_Entry;
   end record;
   type NTP_Dialog is access all NTP_Dialog_Record'Class;
