...
--                                                 Winter, 2018       --
--                                                                    --
--                                Last revision :  12:12 11 Nov 2025  --
--                                                                    --
...
--
-- IsInitialized -- Check if Initialize was called
--
...
--
   ...
   procedure Throw_NotImplementedError (Message : String);
...
------------------------------------------------------------------------
   ...
   type Argument_Count is new Natural;
   subtype Argument_Position is
      Argument_Count range 1..Argument_Count'Last;
...
--
   type Argument_List (Length : Argument_Count) is record
      Keys     : Object_Tables.Table;        -- Key to position map
      Offsets  : Position_Array (1..Length); -- Position to key map
      Optional : Optional_Array (1..Length); -- Optional flag
   end record;
   function No_Arguments return Argument_List;
--
...
--
   ...
   type Actual_Argument_List is
      array (Argument_Position range <>) of Handle;
--
...
--    result contains No_Value in its position.
--
-- Exceptions :
--
...
-- Returns :
--
--    A hande to the referenced object, invalid if the object is gone
--
   function Get (Reference : Weak_Handle) return Handle;
--
-- Set -- The reference
--
--    Reference - To set
--    Object    - To be referenced, it can be an invalid handle
--
   procedure Set
...
------------------------------------------------------------------------
--
-- Python_Module -- Python module, high-level interface
--
-- The Python_Module object is created empty. Then function can be added
-- using Add_Function calls.
--
   type Python_Module is
      new Ada.Finalization.Limited_Controlled with private;
   type Module_Keyed_Function_Ptr is access procedure
        (  Module    : in out Python_Module'Class;
           Arguments : Actual_Argument_List;
           Result    : out Handle
        );
   type Module_Positional_Function_Ptr is access procedure
        (  Module    : in out Python_Module'Class;
           Arguments : Actual_Argument_List;
           Result    : out Handle
        );
   type Module_One_Argument_Function_Ptr is access procedure
        (  Module   : in out Python_Module'Class;
           Argument : Handle;
           Result   : out Handle
        );
   type Module_No_Argument_Function_Ptr is access procedure
        (  Module   : in out Python_Module'Class;
           Result   : out Handle
        );
--
...
--
-- Add_Function -- Add function to the module
--
--    Module    - The module
--    Name      - The function name
--    Doc       - The function documentation text
--    Profile   - The function argument list profile
--    Operation - Ada implementation of the function
--
-- Exceptions :
--
--    Use_Error - The module was not yet created or cannot be modified
--
...
--
-- Get_Basic_Size -Get tp_basicsize slot
--
--    The object
--
-- Returns :
--
--    The tp_basicsize slot
--
-- Exceptions :
--
--    Constraint_Error - Object is invalid
--
   function Get_Basic_Size (Object : Handle) return ssize_t;
...
-- pragma Convention (C, GILState_Check_Ptr);
   ...
   type IsInitialized_Ptr is access function return int;
   pragma Convention (C, IsInitialized_Ptr);
   ...
   type Import_GetModuleDict_Ptr is access function return Object;
   pragma Convention (C, Import_GetModuleDict_Ptr);
...
-- pragma Convention (C, List_CheckExact_Ptr);
   ...
   type CFunction_NewEx_Ptr is access function
        (  Method  : MethodDef;
           Self    : Object;
           Module  : Object
        )  return Object;
   pragma Convention (C, CFunction_NewEx_Ptr);
...
-- pragma Convention (C, Sys_GetSizeOf_Ptr);
   ...
   type Weakref_GetObject_Ptr is access function
        (  Ref : Object
        )  return Object;
   pragma Convention (C, Weakref_GetObject_Ptr);

   type Weakref_NewProxy_Ptr is access function
        (  This     : Object;
           Callback : Object
        )  return Object;
   pragma Convention (C, Weakref_NewProxy_Ptr);

   type Weakref_NewRef_Ptr is access function
        (  This     : Object;
           Callback : Object
        )  return Object;
   pragma Convention (C, Weakref_NewRef_Ptr);
------------------------------------------------------------------------
   ...
   package Links is
      ...
      CFunction_NewEx              : CFunction_NewEx_Ptr;
...
--    Dict_SetDefault              : Dict_Setdefault_Ptr;
      ...
      Exc_NotImplementedError      : Object_Ptr;
...
--    GILState_Check               : GILState_Check_Ptr;
      ...
      Import_GetModuleDict         : Import_GetModuleDict_Ptr;
      ...
      IsInitialized                : IsInitialized_Ptr;
...
--    List_CheckExact              : List_CheckExact_Ptr;
      ...
      NotImplemented               : Object := Null_Object;
...
--    Sys_GetSizeOf                : Sys_GetSizeOf_Ptr;
      ...
      Weakref_GetObject            : Weakref_GetObject_Ptr;
      Weakref_NewProxy             : Weakref_NewProxy_Ptr;
      Weakref_NewRef               : Weakref_NewRef_Ptr;
   end Links;
...
--
   ...
   type Python_Module_Ptr is access all Python_Module'Class;
   type Method_Arguments_Type is
        (  Keyed,
           Positional,
           Single,
           None
   ...
   type Method_Data
        (  Kind_Of : Method_Arguments_Type;
           Length  : Argument_Position
        )  is new Ada.Finalization.Controlled with
   record
      Self       : Object;
      Definition : aliased MethodDef;
      Module     : Python_Module_Ptr;
      case Kind_Of is
         when Keyed =>
            Keyed_Operation        : Module_Keyed_Function_Ptr;
            List                   : Argument_List (Length);
         when Positional =>
            Positional_Operation   : Module_Positional_Function_Ptr;
         when Single =>
            One_Argument_Operation : Module_One_Argument_Function_Ptr;
         when None =>
            No_Argument_Operation  : Module_No_Argument_Function_Ptr;
      end case;
   end record;
   procedure Adjust   (Data : in out Method_Data);
   procedure Finalize (Data : in out Method_Data);

   type ModuleDef_Ptr is access ModuleDef;
   type Python_Module is
      new Ada.Finalization.Limited_Controlled with
   record
      Module     : Object := Null_Object;
      Definition : ModuleDef_Ptr;
   end record;

   procedure Finalize (Module : in out Python_Module);
------------------------------------------------------------------------
...
------------------------------------------------------------------------
--
-- Finalization_Hook -- Python finalization hook
--
   type Finalization_Hook_Ptr is access procedure;
--
-- Add_Hook -- Add a callback from FinalizeEx
--
--    Hook  - The procedure to call
--    After - If true  the hook is called after  Py_FinalizeEx otherwise
--            iy is called before
--
   procedure Add_Hook
...
--
-- External_Storage -- Help pool  to  initialize and finalize Ada values
--                     allocated in Python
--
   type External_Storage is
   ...
   Value_Handler : External_Storage;

   Base_Is_Not_A_Type   : constant String := "Base is not a type";
   Base_Arguments_Error : constant String := "Wrong base arguments";
   Cannot_Add_Module    : constant String := "Cannot add module";
   Class_Already_Exists : constant String := "Class already exists";
   Class_Does_Not_Exist : constant String := "Class does not exist";
   Error_Getting        : constant String := "Error getting member ";
   Error_Setting        : constant String := "Error setting member ";
   Not_Created          : constant String := "Module is not created";
   Not_A_Type           : constant String := "Not a type";
   Wrong_Argument_Type  : constant String := "Wrong argument type";
   Null_Value_Argument  : constant String := "Argument is a null value";
   Too_Large_Integer    : constant String := "Too large lnteger value";
