...
package body Parsers.Generic_Source.Patterns.Generic_User_Pattern is
   ...
   begin
      ...
      Start := Pointer;
      if Match (Line (Pointer..Last), Pointer'Access) then
   ...
   function Pattern return Pattern_Type is
   begin
      return Ref (new User_Defined_Pattern);
   end Pattern;
