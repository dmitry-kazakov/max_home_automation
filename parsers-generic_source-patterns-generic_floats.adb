...
package body Parsers.Generic_Source.Patterns.Generic_Floats is

   function Image (Pattern : Float_Pattern_Type) return String is
   begin
      return "Float (Base " & Image (Integer (Pattern.Base)) & ')';
   end Image;

   function Image (Hook : Float_Hook_Handler) return String is
   begin
      return "";
   end Image;
   ...
   function Float_Pattern
      ...
      This   : Float_Pattern_Type renames
                  Float_Pattern_Type (Ptr (Pattern).all);
      Result : Pattern_Ptr;
   begin
      This.First := First;
      This.Last  := Last;
