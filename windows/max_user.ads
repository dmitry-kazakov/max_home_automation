...
--
-- User_Path -- The path to the user directory
--
-- Returns :
--
--    The path
--
   function User_Path return UTF8_String;
--
-- NTP_Servers -- The list of system NTP servers
--
-- Returns :
--
--    The list of servers
--
   function NTP_Servers return Servers_List.Set;
