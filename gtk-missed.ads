...
--                                                                    --
--                                Last revision :  09:36 10 Dec 2023  --
--                                                                    --
...
--
-- Get_CSS_Name -- Get CSS class style name
--
--    Class - The class
--
-- Returns :
...
--
   function Get_CSS_Name (Class : GObject_Class) return UTF8_String;
--
-- Get_Iter_At_Location -- Backward compatibility layer
-- Get_Iter_At_Position
--
-- The GTK interface  was changed  between  3.19 and  3.20 versions this
-- implementation selects a proper target.
--
...
--
-- Set_CSS_Name -- Set CSS class style name
--
--    Class - The class
