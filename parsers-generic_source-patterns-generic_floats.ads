...
generic
   with package Edit is new Strings_Edit.Float_Edit (<>);
package Parsers.Generic_Source.Patterns.Generic_Floats is
   subtype Number is Edit.Number;

   type Float_Array is array (Positive range <>) of Number;
   package Float_Arrays is
      new Generic_Unbounded_Array
          (  Index_Type        => Positive,
             Object_Type       => Number,
             Object_Array_Type => Float_Array,
             Null_Element      => Number'First
          );
   use Float_Arrays;
--
-- Float_Pattern -- Variable that can be assigned upon patter matching
--
   function Float_Pattern
...
private
   ...
   function Image (Pattern : Float_Pattern_Type) return String;
   function Match
            (  Pattern : Float_Pattern_Type;
   ...
   type Float_Hook_Handler
        (  Pointer : access Positive
        )  is new Hook_Handler with null record;
   function Image (Hook : Float_Hook_Handler) return String;
   procedure On_Failure
             (  Hook   : in out Float_Hook_Handler;
                Source : in out Source_Subtype
             );
   function On_Line_Change
            (  Hook   : access Float_Hook_Handler;
               Source : access Source_Subtype;
...
end Parsers.Generic_Source.Patterns.Generic_Floats;
